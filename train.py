...
# ============================================================
# HELPER: DOWNLOAD DATA IF MISSING
# ============================================================

def maybe_download_wineqt():
    if os.path.exists("WineQT.csv"):
        return

    print("⚙️ WineQT.csv not found locally. Attempting download from UCI repository...")
    try:
        ...
        print('✅ Downloaded and saved WineQT.csv (red+white combined).')
    except Exception as e:
        print('❌ Failed to download dataset automatically:', e)
        print('Please place WineQT.csv in the script directory and run again.')
        sys.exit(1)
